...
# Extract - Data extraction is getting data from multiple sources.
# Ex. Data extraction from a website using Web scraping or gathering information from the data that are stored in different formats(JSON, CSV, XLSX etc.).
...
import piplite
piplite.install(['seaborn', 'lxml', 'openpyxl'])
...
async def main():
    ...
    print(df.head())  # Added to display the dataframe for verification
...
async def download_diabetes():
    await download(filename, "diabetes.csv")

await download_diabetes()
